...
internal val Base = Color(0xFF0C0906)        // fondo
internal val Surface = Color(0xFF151009)     // panel
internal val SurfaceHigh = Color(0xFF1E170E) // panel elevado, fila resaltada
internal val Line = Color(0xFF3A2E1C)        // separadores, con tinte de bronce
...
private fun scheme(accent: Color) = darkColorScheme(
    ...
    surfaceContainerHighest = Color(0xFF261D12),
    outline = Line,
    outlineVariant = Color(0xFF2A2114),
